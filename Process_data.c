...
void Process_Data(void)
{
    ...
    if(0 == ping) {
        ...
        _fir(RxPing+0, TxPing+0, FRAMESIZE, &s_left, 2);
        _fir(RxPing+1, TxPing+1, FRAMESIZE, &s_right, 2);
...
//        memcpy(TxPing, RxPing, 2*FRAMESIZE*sizeof(RxPing[0]));
        ...
        _fir(RxPong+0, TxPong+0, FRAMESIZE, &s_left, 2);
        _fir(RxPong+1, TxPong+1, FRAMESIZE, &s_right, 2);
